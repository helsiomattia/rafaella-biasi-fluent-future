            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-secondary/20">
                ...
                >
                  ...
                  <div className={`p-4 text-sm max-w-[80%] ${
                    msg.sender === "user" 
                      ...
                      : "bg-card border border-border shadow-sm text-foreground rounded-2xl rounded-tl-sm leading-relaxed"
                  }`}>
                    {msg.text}
                  </div>
              ...
              {isTyping && (
                 <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex justify-start gap-3">
                    ...
                    <div className="bg-card border border-border p-4 rounded-2xl rounded-tl-sm flex items-center gap-1.5 h-10 w-16">
